...
#
# Usage:
#   ARCH=deepsphere PROBE=combined CONFIGS_GLOB="configs/maps/dev/deepsphere/combined/bench_v7/*.yaml" \
...
: "${CONFIGS_GLOB:?set CONFIGS_GLOB, e.g. configs/maps/dev/deepsphere/combined/bench_v7/*.yaml}"
