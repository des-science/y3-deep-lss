# bench_v11 — LENSING, THE TRANSPLANT

**Status (2026-08-28): LAUNCHED.** 2 arms, 2 jobs, single 12 h each (no chain). Jobs 3211837 (simple), 3211838 (simple_mean_std).

**The question.** bench_v11 on COMBINED settled that the *readout* is the whole gain and the
machinery is not. This round asks whether that holds on lensing alone — the last thing between here
...
R=/iopsstor/scratch/cscs/athomsen/deep_lss/runs/v18/default/maps/lensing
